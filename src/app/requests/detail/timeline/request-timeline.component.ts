          ...
          <div class="relative pb-8">
            ...
            <div class="relative flex space-x-3">
              <div>
                ...
                >
                  <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                    <path stroke-linecap="round" stroke-linejoin="round" [attr.d]="getEventIconPath(event.type)" />
                  </svg>
                </span>
              </div>
...
export class RequestTimelineComponent {
  ...
  private readonly eventIconPaths: Record<string, string> = {
    ...
    pr_linked: 'M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14',
    file_attached: 'M15.172 7l-6.586 6.586a2 2 0 102.828 2.828l6.414-6.586a4 4 0 00-5.656-5.656l-6.415 6.585a6 6 0 108.486 8.486L20.5 13',
  };
  ...
  getEventIconPath(type: string): string {
    return this.eventIconPaths[type] || 'M5 13l4 4L19 7';
  }
