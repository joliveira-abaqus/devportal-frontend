...
import { StatusBadgeComponent } from '../../../shared/components/domain/status-badge.component';
import { RequestTimelineComponent } from '../../../shared/components/domain/request-timeline.component';
            ...
            <div>
              ...
              <div class="mt-2 flex items-center gap-3">
                ...
                <span class="text-sm text-gray-400 dark:text-gray-500">
                  Criado em {{ formatDateFn(request.createdAt) }}
                </span>
              </div>
            </div>
          </div>
