...
import { formatRelativeDate, requestTypeLabels } from '../../shared/utils';
    ...
    <a [routerLink]="['/requests', request.id]">
      <app-card className="transition-shadow hover:shadow-md">
        <div class="flex items-start justify-between">
          ...
          <svg class="ml-4 h-5 w-5 flex-shrink-0 text-gray-400 dark:text-gray-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
