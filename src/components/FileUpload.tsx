...
export default function FileUpload({ onFileSelect, selectedFile }: FileUploadProps) {
  ...
  return (
    <div className="w-full">
      <label className="mb-1 block text-sm font-medium text-gray-700">Arquivo anexo (opcional)</label>
      ...
      {selectedFile ? (
        ...
        >
          ...
          <p className="text-sm text-gray-600">
            <span className="font-medium text-brand-600">Clique para enviar</span> ou arraste um arquivo
          </p>
